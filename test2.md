...
- **[Startup Offers] (https://azure.microsoft.com/en-us/pricing/member-offers/bizspark-startups/)** - Get free cloud credits and offers through Microsoft’s BizSpark program.
 ...
          <td valign="top">
  <h3>:video_camera:<i> Getting Started video series</i></h3>
    ...
    -    <b>[Additional Getting Started on Azure videos] (https://azure.microsoft.com/en-us/get-started/)</b> - View additional Getting Started on Azure vidoes such as Windows Server Virtual Machines, Web Apps, SQL Database on Azure and more.
	   </td>
         </tr>
    </table> 
